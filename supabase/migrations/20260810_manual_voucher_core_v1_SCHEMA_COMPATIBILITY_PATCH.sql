-- RAWAEA Manual Stock Voucher Core V1 — SCHEMA COMPATIBILITY PATCH
-- Purpose: remove the unsupported stock_vouchers.received_by dependency.
-- The existing inventory_log.user_email remains the authoritative actor evidence.
