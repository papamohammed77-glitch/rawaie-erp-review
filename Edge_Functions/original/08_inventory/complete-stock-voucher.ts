// complete-stock-voucher – إكمال إذن مخزني (آمنة)
...
serve(async (req) => {
  ...
  try {
    ...
    if (voucher.status === "Completed") throw new Error("الإذن مكتمل بالفعل")
    ...
    return new Response(JSON.stringify({ success: true, msg: "تم إكمال الإذن" }), {
